...
ex2.onclick = function () {
    ...
    video.style.display = 'block'
    video.src = 'https://www.youtube.com/embed/wMn2qgEJwzU'

    criaShape(8, 10, 12, 9, 10, 12, 9, 10, 12, 9, 11, 12, 10, 12, 13, 10, 12, 14)
...
ex3.onclick = function () {
    ...
    lista.style.top = '-580px'
    video.style.display = 'block'
    video.src = 'https://www.youtube.com/embed/zwXlgnVZa4w'
    pdf.style.display = 'none'
    video1.style.display = 'none'
    base.style.display = 'none'
    base.pause()
    ...
    base.currentTime = 0
    criaShape(10, 12, 14, 10, 12, 14, 10, 12, 14, 11, 12, 14, 12, 13, 15, 12, 14, 15)
}
...
ex4.onclick = function () {
    ...
    lista.style.top = '-580px'
    video.style.display = 'block'
    video.src = 'https://www.youtube.com/embed/Nvcjpfv8P2g'
    pdf.style.display = 'none'
    video1.style.display = 'none'

    base.style.display = 'none'
    soundslice.style.display = 'none'
    criaShape(0, 2, 3, 0, 2, 3, 0, 2, 4, 0, 2, 4, 1, 3, 5, 2, 3, 5)
